<?php
namespace app\common\controller\OSS;

use app\common\controller\OSS\Core\MimeTypes;
use app\common\controller\OSS\Core\OssException;
use app\common\controller\OSS\Http\RequestCore;
use app\common\controller\OSS\Http\RequestCore_Exception;
use app\common\controller\OSS\Http\ResponseCore;
use app\common\controller\OSS\Model\CorsConfig;
use app\common\controller\OSS\Model\CnameConfig;
use app\common\controller\OSS\Model\LoggingConfig;
use app\common\controller\OSS\Model\LiveChannelConfig;
use app\common\controller\OSS\Model\LiveChannelInfo;
use app\common\controller\OSS\Model\LiveChannelListInfo;
use app\common\controller\OSS\Model\StorageCapacityConfig;
use app\common\controller\OSS\Result\AclResult;
use app\common\controller\OSS\Result\BodyResult;
use app\common\controller\OSS\Result\GetCorsResult;
use app\common\controller\OSS\Result\GetLifecycleResult;
use app\common\controller\OSS\Result\GetLocationResult;
use app\common\controller\OSS\Result\GetLoggingResult;
use app\common\controller\OSS\Result\GetRefererResult;
use app\common\controller\OSS\Result\GetStorageCapacityResult;
use app\common\controller\OSS\Result\GetWebsiteResult;
use app\common\controller\OSS\Result\GetCnameResult;
use app\common\controller\OSS\Result\HeaderResult;
use app\common\controller\OSS\Result\InitiateMultipartUploadResult;
use app\common\controller\OSS\Result\ListBucketsResult;
use app\common\controller\OSS\Result\ListMultipartUploadResult;
use app\common\controller\OSS\Model\ListMultipartUploadInfo;
use app\common\controller\OSS\Result\ListObjectsResult;
use app\common\controller\OSS\Result\ListPartsResult;
use app\common\controller\OSS\Result\PutSetDeleteResult;
use app\common\controller\OSS\Result\DeleteObjectsResult;
use app\common\controller\OSS\Result\CopyObjectResult;
use app\common\controller\OSS\Result\CallbackResult;
use app\common\controller\OSS\Result\ExistResult;
use app\common\controller\OSS\Result\PutLiveChannelResult;
use app\common\controller\OSS\Result\GetLiveChannelHistoryResult;
use app\common\controller\OSS\Result\GetLiveChannelInfoResult;
use app\common\controller\OSS\Result\GetLiveChannelStatusResult;
use app\common\controller\OSS\Result\ListLiveChannelResult;
use app\common\controller\OSS\Result\AppendResult;
use app\common\controller\OSS\Model\ObjectListInfo;
use app\common\controller\OSS\Result\SymlinkResult;
use app\common\controller\OSS\Result\UploadPartResult;
use app\common\controller\OSS\Model\BucketListInfo;
use app\common\controller\OSS\Model\LifecycleConfig;
use app\common\controller\OSS\Model\RefererConfig;
use app\common\controller\OSS\Model\WebsiteConfig;
use app\common\controller\OSS\Core\OssUtil;
use app\common\controller\OSS\Model\ListPartsInfo;
